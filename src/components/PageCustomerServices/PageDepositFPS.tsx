  ...
  return (
    <>
      ...
      <main className="flex flex-col">
        ...
        />
        <div style={{ backgroundColor: 'white', paddingTop: '40px' }} className='deposit-bank-fix'>
          ...
          <div className='body-regular-text' dangerouslySetInnerHTML={{ __html: g(k.data, 'fps_info') }}></div>
          <h1 style={{ color: 'grey' }} className={`h6-text pt-8`}>{g(k.data, 'text_1')}</h1>
          {
          ...
          <h1 style={{ color: 'grey', paddingTop: '20px' }} className={`small-text`} dangerouslySetInnerHTML={{ __html: g(k.data, 'note') }}></h1>
        </div >
