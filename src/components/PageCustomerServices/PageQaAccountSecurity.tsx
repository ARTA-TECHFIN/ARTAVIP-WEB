...
const PageQaAccountSecurity: FC<{ k: PageAboutCmsT }> = ({ k }) => {
  ...
  return (
    <>
      <Seo
        title={`${t('customer_service.qa_security_account')} | Arta TechFin`}
        description={t('customer_service.qa_security_account')}
        keywords={t('customer_service.qa_security_account')}
        ga="QA Open Accounts"
      />
      <Header textColor="brown" />
      {/* <img src='/images/about/white-2024-06-14-62049.png' alt="" className="object-cover w-full h-[152px]" />
      <div id="account-security-bd">
            <h1 style={{ fontSize: '60px',color:"white" ,display:'flex', alignItems:'center', justifyContent:'left',fontWeight:'700px'}}>{t('customer_service.qa_security_account')}</h1>
     </div> */}
      <main className="flex flex-col">
        <HeroBanner
          title={t('customer_service.qa_security_account')}
          description=''
