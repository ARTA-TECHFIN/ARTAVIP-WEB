    ...
    <>
     ...
     <div style={{backgroundColor:'white',paddingLeft:'5%',paddingTop:'40px'}}>
        ...
        <div style={{paddingRight:'10%'}}>
          <div style={{fontSize:'25px',color:'gray',backgroundColor:'white'}}>{g(k.data.attributes, 'headline')}</div>
        ...
        <div style={{paddingRight:'10%'}}>
          <div style={{fontSize:'25px',color:'gray',backgroundColor:'white'}}>{g(k.data2.attributes, 'headline')}</div>
          <div className='qa-open-account-left'>
          {
