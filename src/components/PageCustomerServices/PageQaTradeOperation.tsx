...
import { PageAboutCmsT } from 'src/pages/customer-services/qa-trade-operation'
...
const PageQaTradeOperation: FC<{ k: PageAboutCmsT }> = ({ k }) => {
  ...
  return (
    <>
      ...
      <div id="services-charges-bd">
            <h1 style={{ fontSize: '60px',color:"white" ,display:'flex', alignItems:'center', justifyContent:'left',fontWeight:'700px'}}>{t('customer_service.qa_trade_operation')}</h1>
     </div>
