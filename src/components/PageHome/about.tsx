...
const about: React.FC = () => {
  return (
    <div className="relative z-3 h-screen w-screen flex will-change-transform">
      ...
      <div className="absolute right-[3em] bottom-[0] lg:bottom-auto lg:top-1/2 transform -translate-y-1/2 flex z-1 justify-end self-center w-[70em] lg:w-[50em]">
        <div className="ml-auto text-right h-full lg:w-1/2 flex-col items-end justify-center gap-[24px] p-6  ">
          ...
          <p className="font-Neue text-[3.6em] lg:text-[1em] text-white max-w-[30em] mb-[1.5em]">
