...
const PageProductsSecuritiesHk: FC<{ k: any }> = ({ k }) => {
  ...
  return (
    <div id='securities-tm'>
      ...
      <h1 style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }} className={`${textClass.h6} py-5`}>{t('products_info.hk_trade_tips')}</h1>
      <div className={`${textClass.small_text}`} style={{ paddingLeft: '15%', alignItems: 'center', justifyContent: 'center', paddingTop: '30px', backgroundColor: 'white' }}
