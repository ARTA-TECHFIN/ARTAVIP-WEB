...
const HKTycoons = (props: propsT) => {
  return (
    <svg className={props.className} width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M18.5 17V14.75H20V17H23.6V18.5H16.775V21.65H23.45V27.875H20V30.05H18.5V27.875H14.9V26.375H21.95V23.15H15.275V17H18.5ZM13.2269 35.6732L49.8269 18.1982L50.4732 19.5518L13.8732 37.0268L13.2269 35.6732ZM41.225 41.2249H51.05V39.7249H41.225V41.2249ZM51.05 45.05H41.225V43.55H51.05V45.05ZM41.225 48.8H51.05V47.3H41.225V48.8ZM51.05 29.825H41.225V28.325H51.05V29.825ZM41.225 33.65H51.05V32.15H41.225V33.65ZM51.05 37.4H41.225V35.9H51.05V37.4ZM27.95 41.2249H37.775V39.7249H27.95V41.2249ZM37.775 45.0499H27.95V43.5499H37.775V45.0499ZM27.95 48.7999H37.775V47.2999H27.95V48.7999ZM37.775 37.4H27.95V35.9H37.775V37.4ZM14.6 41.225H24.5V39.725H14.6V41.225ZM24.5 45.05H14.6V43.55H24.5V45.05ZM14.6 48.8H24.5V47.3H14.6V48.8Z" fill="currentColor"/>
      </g>
      <circle cx="32" cy="32" r="31" stroke="currentColor" strokeWidth="2"/>
      <defs>
      <clipPath id="clip0_1618_9086">
        <rect width="37.8" height="34.05" fill="currentColor" transform="translate(13.25 14.75)"/>
      </clipPath>
      </defs>
    </svg>
  )
...
const EducationProfessionalIcon = (props: propsT) => {
  return (
    <svg className={props.className} width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M11.75 15.5C11.75 13.8142 13.0642 12.5 14.75 12.5L14.7509 12.5C16.4362 12.5005 17.75 13.8145 17.75 15.5H11.75ZM17.75 17V24.125V27.725V49.25C17.75 51.6122 19.5029 53.5079 21.8 53.7285V53.75H22.25H49.925H50.075V53.7476C52.4929 53.6713 54.3862 51.7536 54.4244 49.325H54.425V49.2621L54.425 49.25L54.425 47.825H46.925V27.725V27.125V15.5C46.925 13.1636 45.2102 11.2835 42.95 11.0293V11H42.425H14.75C12.2358 11 10.25 12.9858 10.25 15.5V17H17.75ZM49.925 52.25H25.6245C26.3119 51.4751 26.7316 50.4554 26.7494 49.325H52.9241C52.8858 50.9746 51.5857 52.25 49.925 52.25ZM25.25 49.25C25.25 50.9358 23.9358 52.25 22.25 52.25C20.5642 52.25 19.25 50.9358 19.25 49.25V27.725V24.125V15.5C19.25 14.3397 18.8271 13.292 18.1245 12.5L42.425 12.5L42.4259 12.5C44.1113 12.5005 45.425 13.8145 45.425 15.5V27.125V27.725V47.825H25.25V49.25ZM23.225 20.075H42.05V18.575H23.225V20.075ZM42.05 26.525H23.225V25.025H42.05V26.525ZM23.225 33.05H42.05V31.55H23.225V33.05Z" fill="currentColor"/>
      <circle cx="32" cy="32" r="31" stroke="currentColor" strokeWidth="2"/>
    </svg>
  )
}
...
const FinancialInvestmentPlatformIcon = (props: propsT) => {
  return (
    <svg className={props.className} width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M38.375 11.75H15.725V18.35H11.75V39.275V46.925V46.925H22.85V50.975H19.7V52.475H22.85V52.55H41.825V52.475H45.05V50.975H41.825V46.925H53V46.925V39.275V18.35H38.375V11.75ZM40.325 50.975V46.925H24.35V50.975H40.325ZM51.5 39.275V19.85H38.375V35.075H15.725V19.85H13.25V39.275H51.5ZM13.25 40.775V45.425H51.5V40.775H13.25ZM17.225 33.575V13.25H36.875V33.575H17.225ZM20.225 15.425H33.95V24.275H20.225V15.425ZM21.725 16.925V22.775H32.45V16.925H21.725ZM34.475 27.875H19.625V26.375H34.475V27.875ZM26.525 31.25H34.475V29.75H26.525V31.25Z" fill="currentColor"/>
      </g>
      <circle cx="32" cy="32" r="31" stroke="currentColor" strokeWidth="2"/>
      <defs>
      <clipPath id="clip0_286_6845">
        <rect width="41.25" height="40.725" fill="currentColor" transform="translate(11.75 11.75)"/>
      </clipPath>
      </defs>
    </svg>
  )
