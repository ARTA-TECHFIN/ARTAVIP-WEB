...
const fetchCmsData = async () => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_ARTAVIP_HOSTING_PATH}/api/cms/home-about-us?populate=*`)
...
const Disclaimer = (props: { cms: any }) => {
  ...
  return (
    <>
      ...
      <div style={{backgroundColor:'white'}} className='about-us-bd' dangerouslySetInnerHTML={{ __html: g(props.cms, 'info') }}></div>
