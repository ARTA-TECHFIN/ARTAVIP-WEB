...
const HKStockTips = (props: { cms: any,heroBanner:any }) => {
  ...
  return (
    <>
      <Seo
        title={`${t('products_info.hk_trade_tips')} | Arta TechFin`}
        description={t('products_info.hk_trade_tips')}
        keywords={t('products_info.hk_trade_tips')}
        ga="HK Trade Tips"
      />
