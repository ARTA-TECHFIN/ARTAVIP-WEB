...
const HKMarginableStock = (props: { cms: any}) => {
  ...
  return (
    <>
    <Seo
      title={`${t('products_info.sse_marginable_stock')} | Arta TechFin`}
      description={t('products_info.sse_marginable_stock')}
      keywords={t('products_info.sse_marginable_stock')}
      ga="HK Trade Tips"
    />
    <Header textColor="brown" />
    <img src='/images/about/white-2024-06-14-62049.png' alt="" className="object-cover w-full h-[152px]" />
    <div id="services-charges-bd">{t('products_info.sse_marginable_stock')}
    </div>
