...
const USStockTips = (props: { cms: any}) => {
  ...
  return (
    <>
    <Seo
      title={`${t('products_info.us_trade_tips')} | Arta TechFin`}
      description={t('products_info.us_trade_tips')}
      keywords={t('products_info.us_trade_tips')}
      ga="HK Trade Tips"
    />
    <Header textColor="brown" />
    <img src='/images/about/white-2024-06-14-62049.png' alt="" className="object-cover w-full h-[152px]" />
    <div id="services-charges-bd">{t('products_info.us_trade_tips')}
    </div>
    <div style={{ paddingLeft:'10%',fontSize:'15px',alignItems:'center', justifyContent:'center',paddingTop:'30px',backgroundColor:'white'}} 
