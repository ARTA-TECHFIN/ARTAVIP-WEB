...
import PageNewArrangementContent from 'src/components/PageInvestor/PageNewArrangementContent'
...
const NewArrangementContentPage = (props: { k: any }) => {
  ...
  return (
    <InvestorLayout
      ...
      simpleHeader={true}
      seo={{
        title: `${t('investor_relations.new_arrangement_content')} | Arta TechFin`,
        description: t('page_description.investor_relations'),
        keywords: t('page_keywords.investor_relations'),
      }}
    >
      <PageNewArrangementContent />
    </InvestorLayout>
  )
}

export default NewArrangementContentPage
